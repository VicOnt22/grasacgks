...
trait SmartDateRecurTrait {
   ...
   */
  public function subsetInstances(array $instances, $next_index, array $settings = [], $within_day = FALSE) {
   ...
   */
  protected function buildOutput($key, $item, array $settings = []) {
   ...
   */
  public function findNextInstance(array $instances, array $settings = []) {
    $next_index = -1;
