...
abstract class ContentEntityStorageBase extends EntityStorageBase implements ContentEntityStorageInterface, DynamicallyFieldableEntityStorageInterface, BundleEntityStorageInterface {
  ...
  public function loadMultipleRevisions(array $revision_ids) {
    ...
    if ($revision_ids) {
      $revisions_flipped = [];
      // Foreach iteration swap all array keys and their associated values.
      foreach ($revision_ids as $key => $value) {
        $revisions_flipped[$value] = $key;
      }

      $flipped_ids = array_intersect_key($revisions_flipped, $revisions);
