  ...
  protected function findMigrationDependencies($process) {
    ...
    foreach ($this->getProcessNormalized($process) as $process_pipeline) {
      foreach ($process_pipeline as $plugin_configuration) {
        ...
        if (isset($plugin_configuration['plugin']) && in_array($plugin_configuration['plugin'], ['migration', 'migration_lookup'], TRUE)) {
          $return = array_merge($return, (array) $plugin_configuration['migration']);
        }
        if (isset($plugin_configuration['plugin']) && in_array($plugin_configuration['plugin'], ['iterator', 'sub_process'], TRUE)) {
